...
ExecSafe {git clone --no-checkout --branch=gh-pages "https://$($githubusername):$githubaccesstoken@github.com/$githubusername/CSharpToPython.git" tempDir}
...
ExecSafe {git push --force-with-lease}
